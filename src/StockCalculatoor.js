...
const StockCalculator = () => {
  ...
  const handleCalculate = (event) => {
    ...
    const roiValue = ((profitOrLoss / totalInvested) * 100).toFixed(2); // Calculate ROI as a percentage
  ...
  // New function to calculate commission based on type and amount
    ...
    <Container>
      ...
      <Form onSubmit={handleCalculate}>
        ...
        <Form.Group as={Row} controlId="formCurrentPrice">
          <Form.Label column sm={2}>Target Price per Share</Form.Label>
          <Col sm={10}>
            <Form.Control
              type="number"
        ...
        {/* New Form.Group for sell commission */}
